...
function setup() {
 ...
 mute_btn.mouseClicked(mute);
  ...
  rope = new Rope(7,{x:330,y:30});

  rope2 = new Rope(5,{x:350,y:200});

  rope3 = new Rope(9,{x:20,y:30});
  ground = new Ground(canw/2,canh,canw,20);
  
  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(canw/2-400,canh-80,100,100);
  bunny.scale = 0.2;
